      ...
      <template #header>
        <div class="card-header">
          <div class="search-form">
            <el-input v-model="searchForm.keyword" placeholder="搜索SKU/商品/供应商" clearable style="width: 250px" @keyup.enter="fetchData" />
            <el-date-picker
      ...
      <el-table :data="tableData" v-loading="loading" stripe>
        ...
        <el-table-column prop="quantity" label="数量" width="100">
          <template #default="scope">
            <el-tag type="success" size="small">+{{ scope.row.quantity }}</el-tag>
          </template>
        </el-table-column>
...
import { getInboundRecords, createInbound, deleteInbound } from '@/api/inbound'
...
const handleDelete = (row) => {
  ElMessageBox.confirm('确定要删除这条入库记录吗？删除后库存将回滚。', '提示', {
