...
import { Table, Button, Modal, Form, Input, Select, Switch, Space, Popconfirm, message, Tag, InputNumber, TimePicker } from 'antd';
    ...
    <div>
      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Item name="skills" label="技能" rules={[{ required: true, message: '请选择技能' }]}>
